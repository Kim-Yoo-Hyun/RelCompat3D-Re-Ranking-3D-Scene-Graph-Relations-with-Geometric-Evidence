...
def main() -> int:
    ...
    if strict_models.get("schema_version") != "relcompat3d_strict_train_only_calibrators_v1":
    ...
    validations = {
        ...
        "strict_model_schema": strict_models.get("schema_version") == "relcompat3d_strict_train_only_calibrators_v1",
    ...
    summary = {
        "schema_version": "relcompat3d_structured_main_evaluation_v1",
        ...
        "docker_command": "env UID=$(id -u) GID=$(id -g) docker compose -f configs/relcompat3d/compose.yaml run --rm structured_main_evaluation",
    }
    ...
    manifest = {
        "schema_version": "relcompat3d_structured_main_manifest_v1",
