...
| VL-SAT | `all_family_product` | 0.9277 | 0.0197 | 0.9658 | 0.0295 |
...
| Open3DSG | `all_family_product` | 0.4418 | 0.0342 | 0.5685 | 0.0324 |
...
| SGFN | `all_family_product` | 0.7450 | 0.0263 | 0.9303 | 0.0350 |
...
`compatibility_only` removes the source score only for proximity and vertical-order candidates. Support/contact candidates remain in source order.
