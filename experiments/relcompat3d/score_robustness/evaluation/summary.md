...
This analysis uses the reported candidate pool, source predictions, family-aware ranking, fitted models, and scan-cluster bootstrap procedure.

## Reproduction checks

- Identity Linear/MLP and Source match the reported results: `True`.
- Input hashes match the recorded manifests: `True`.
