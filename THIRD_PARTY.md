...
third-party model checkpoints below.

| Resource | Use | Upstream |
| --- | --- | --- |
| 3RScan | Reconstructed scenes | https://github.com/WaldJohannaU/3RScan |
...
this repository applies only to original RelCompat3D code unless a file states
otherwise.
